...
class USBReceiverWorker(QObject):
    ...
    # 2) Local project folder
        local_adb = os.path.join("C:\Program Files\Eazycam Desktop\Android\platform-tools", "adb.exe")
        ...
        try:
            subprocess.run([adb_cmd, 'forward', 'tcp:23233', 'tcp:23233'], check=True, capture_output=True, creationflags=subprocess.CREATE_NO_WINDOW,
    startupinfo=si)
