      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8.h),
            _SectionHeader(title: 'CONNECTION', color: MyColors.grey),
            SizedBox(height: 8.h),
            _SettingsGroup(
            ...
            _SectionHeader(title: 'SUPPORT & INFO', color: MyColors.grey),
            SizedBox(height: 8.h),
            _SettingsGroup(
              backgroundColor: _darkSurface,
              children: [
                _ActionTile(
                  ...
                  value: '',
                  textColor: _textPrimary,
                  onTap: () => _handleFeatureComingSoon("FAQs Page"),
                ),
                _CustomDivider(color: _darkBackground),
                _ActionTile(
                  ...
                  value: '',
                  textColor: _textPrimary,
                  onTap: () => _handleFeatureComingSoon("Privacy Policy"),
                ),
                _CustomDivider(color: _darkBackground),
                _ActionTile(
                  ...
                  value: '',
                  textColor: _textPrimary,
                  onTap: () => _handleFeatureComingSoon("About Page"),
                ),
              ],
            ),
